        ...
        "imgs": [
            {
                ...
                "url": f'{server}/static/{os.path.basename(coffees.iloc[0,6])}',
                #"video": f"{server}/static/tmp.mp4",
            },
            {
                "title": coffees.iloc[1, -1],
                "url": f'{server}/static/{os.path.basename(coffees.iloc[1,6])}',
            },
            {
                "title": coffees.iloc[2, -1],
                "url": f'{server}/static/{os.path.basename(coffees.iloc[2,6])}',
            },
        ]
    }
